...
const QMetaObjectExtraData FindForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FindForm::staticMetaObject = {
    { &FindReplaceForm::staticMetaObject, qt_meta_stringdata_FindForm,
      qt_meta_data_FindForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FindForm::getStaticMetaObject() { return staticMetaObject; }
