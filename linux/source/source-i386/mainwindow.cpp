...
void MainWindow::on_actionAurora_default_triggered()
{
    this->setStyleSheet("background : #efefef; color : #4d4d4c; selection-background-color : #0055ef; selection-color: #ffffff;");
    ui->textEdit->setStyleSheet("background : #ffffff; color : #000000");
}

void MainWindow::on_actionMoon_triggered()
{
    this->setStyleSheet("background : #969f9e; color : #c7d2d1; selection-background-color : #abb5b4; selection-color: #ffffff;");
    ui->textEdit->setStyleSheet("background : #545958; color : #c7d2d1");
}
